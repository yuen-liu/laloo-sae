...
Both failures share a mechanism: TopK sparsity forces each pose's 120-dimensional representation down to its $K$ largest activations, and $K$ is small precisely where the representation is most aggressively sparse and thus most interpretable by the usual argument for using SAEs at all.
