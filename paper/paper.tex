...
\setlength{\textfloatsep}{7pt plus 2pt minus 4pt}   % space between a top/bottom-floated table and body text (default ~20pt)
\setlength{\floatsep}{5pt plus 2pt minus 2pt}       % space between consecutive floats (default ~12pt)
\setlength{\intextsep}{4pt plus 2pt minus 2pt}      % space around an in-text [h] float (default ~12pt)
